...
class InstallerController extends Controller
{
    ...
    public function finishInstall()
    {
        ...
        try {
            ...
            throw new \Exception(_('Migrations or Seeds failed with following message').' "'.$e->getMessage().'"" '. _('Please re-create your database and try again. If error persists, please contact us.'));
        }
